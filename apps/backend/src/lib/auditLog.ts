...
const ENTITY_LABELS: Record<string, string> = {
  ...
  MaterialRequestComment: 'Comentário de RM',
  PurchaseOrderComment: 'Comentário de OC',
  ...
  JuridicoProcesso: 'Processo jurídico',
  JuridicoProcessoAnexo: 'Anexo de processo',
  JuridicoProcessoComprovante: 'Comprovante de processo',
  Licitacao: 'Licitação',
